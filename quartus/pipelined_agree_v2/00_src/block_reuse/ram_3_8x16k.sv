module ram_3_8x16k (
  ...
  (* ram_init_file = "D:/Onedrive/BK21-25/24-25-Sem8/GraduationProject/Github/Grad_Project_RISCV_core/quartus/pipelined_agree_v2/02_dmemdata/ram3.hex" *)  logic [7:0] data_mem [0:16383];
